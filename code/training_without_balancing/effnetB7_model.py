...
# Define model (EfficientNet-B7 with 3-channel input for grayscale images)
class EffNetB7Classifier(nn.Module):
    def __init__(self, num_classes=3):
        super(EffNetB7Classifier, self).__init__()
        ...
        # Adjust the classifier to match the number of output classes
...
model = EffNetB7Classifier(num_classes=3).to(device)
